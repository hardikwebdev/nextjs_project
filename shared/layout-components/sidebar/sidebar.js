...
import { getGeneralConfig } from "../../services/Front_Apis/homePage/homePageCrud";
let history = [];
      ...
      >
        ...
        >
          <div className="main-sidebar-header active">
            <Link className="header-logo active" href={`/admin/dashboard/`}>
              <img
                src={data?.site_logo}
                                ...
                                {childrenItem.type === "link" ? (
                                  <span as="li">
                                    <Link
                                      ...
                                      className={`slide-item ${location.pathname == childrenItem.path
                                        ? " active"
                                        : ""
                                        }`}
                                      onClick={() =>
                                        handleMenuItemClick(childrenItem.title)
                                      }
                                    >
                                      {childrenItem.title}
                                      {childrenItem.active}
                                        ...
                                        <li key={key}>
                                          {childrenSubItem.type === "link" ? (
                                            <Link
                                              ...
                                              className={`sub-side-menu__item ${location.pathname ==
