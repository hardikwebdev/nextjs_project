...
import { Pagination, Spinner, Container, Row, Col, Card, Breadcrumb, Form, Button, Alert } from 'react-bootstrap';
...
function NewsDetailPage({ data }) {
    ...
    const getBlogItem = () => {
        ...
        if (access_token) {
            getBlogData(access_token, page, pageSize, sortBy, sortOrder, false)
                .then(({ data }) => {
    ...
    const handleEditData = (data) => {
        dispatch(setBlogAndNewsData(data))
    }
                    ...
                    <Row>
                                        ...
                                        {comments?.total > 0 ?
                                            <div className='comment_div'>
                                                ...
                                                {/* {comments?.blogsCommentData?.map((data, index) => (
                                                    <div className='comment_data p-3 background-color-3 d-flex mb-4'>
                                                        <>
                        ...
                        <Col md={12} lg={6} xl={5} className='mt-4 mt-md-0 mb-4 mb-lg-0'>
                            <Row className='m-0'>
                                ...
                                <Link href="/blog" className='tx-18'><i className="fa fa-arrow-left me-2"></i>Go back to blogs</Link>
                            </Row>
