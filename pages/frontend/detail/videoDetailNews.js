                    ...
                    <div className='social_media w-100 float-left mb-4 mt-5'>
                        ...
                        <p className='copy_link m-0 d-inline-block me-2 float-left lh-2'>
                            {linkCopy ?
                                ...
                                :
                                <span className='d-flex align-items-center cursor-pointer padd_8_16 social_media_border' onClick={handleCopyLink}><img src={"../../../assets/img/front/Outline.png"}></img><span className='tx-18 ps-2'>Copy Link</span>
                                </span>
                            }
                        </p>
